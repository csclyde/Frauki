...
ScriptRunner.scripts['azp3_intro'] = [
	{ name: 'disallow_input', props: {} },

	{ func: function() {
		var azp3 = objectController.enemyList.find(function(e) {
			return e.name === 'tower_troll';
		});

        events.publish('pan_camera', { to: azp3.body.center, duration: 1000 });
	} },
...
ScriptRunner.scripts['kr32_intro'] = [
	{ name: 'disallow_input', props: {} },

	{ func: function() {
		var kr32 = objectController.enemyList.find(function(e) {
			return e.name === 'tower_ninja';
		});

        events.publish('pan_camera', { to: kr32.body.center, duration: 1000 });
	} },
