Enemy.prototype.types['HWK9'] =  function() {
    ...
    this.animations.add('idle', ['HWK9/AttackWallHang0000'], 8, true, false);
    this.animations.add('attack_throw', ['HWK9/AttackWallHang0001', 'HWK9/AttackWallHang0002', 'HWK9/AttackWallHang0003', 'HWK9/AttackWallHang0004'], 10, false, false);
	...
	this.body.maxVelocity.setTo(600);
	...
	this.Act = function() {
        ...
        if(EnemyBehavior.Player.IsVisible(this)) {
			...
			if(this.state === this.Idling && this.CanAttack() && EnemyBehavior.Player.IsNear(this, 240)) {
				this.ThrowBomb();
			}
            else if(EnemyBehavior.Player.IsNear(this, 280) && !EnemyBehavior.Player.IsDangerous(this) && this.CanAttack()) {
                this.Slash();
            }
